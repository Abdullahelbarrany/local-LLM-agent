"""
Project-management tool definitions and handlers.

This module was originally tools.py; it now lives in tools/__init__.py so that
the tools/ package can also hold job_scrapers, job_cache, and cv_versions without
conflicting with this file.  All existing imports (from tools import TOOL_DEFINITIONS)
